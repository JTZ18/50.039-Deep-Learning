...
class UNET(nn.Module):
    def __init__(
        ...
        for feature in features:
            self.downs.append(DoubleConv(in_channels, feature, kernel_size, dropout_rate=dropout_rate))
            in_channels = feature
        ...
        for feature in reversed(features):
            ...
            self.ups.append(DoubleConv(feature*2, feature, kernel_size, dropout_rate=dropout_rate))

        self.bottleneck = DoubleConv(features[-1], features[-1]*2, kernel_size, dropout_rate=dropout_rate)
